    ...
    // cria referência aos radiobutton's e associa função evento change
    ...
    function mostrarNumSabores() {
        ...
        if (rbPizza.checked){
            ...
            // atributo placeholder = "Até " + num + " sabores";
        }
    }
    ...
    function limparCampos() {
        ...
        inBebida.className = "oculta";  // oculta select das Bebidas
        inPizza.className = "exibe";    // exibe select das Pizza
        inPizza.selectIndex = 0;        // seleciona 1° item (posição 0)
